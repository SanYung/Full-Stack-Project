...
channel4 = Channel.create!(title:'Foodies!', user_id: user1.id)
...
post3 = Post.create!(body: "and I like to eat green eggs and ham", user_id: user1.id, channel_id: channel1.id)
