...
class Search extends React.Component {
    ...
    //         let res = this.props.allchannels[id].is_private;
    //         if (res === true) {
    //             return <RiLockLine /> 
    //         } else {
    ...
    //     this.props.allchannelsarr.forEach(channel => {
    //         const sub = channel.title.slice(0, this.state.inputValue.length);
    //         if (sub.toLowerCase() === this.state.inputValue.toLowerCase()) {
    //             matches.push(<button onMouseDown={() => this.props.history.push(`/home/channels/${channel.id}`)}>{lockDisplay(channel.id)}{channel.name}</button>);
    //         }
    //     });
    ...
    //             matches.push(<button onMouseDown={() => this.props.history.push(`/home/channels/${dmUrl}`)}><i className="far fa-user"></i>{user.username}</button>);
    //         }
    //     });
